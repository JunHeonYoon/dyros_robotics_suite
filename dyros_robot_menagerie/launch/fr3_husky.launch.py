...
def generate_launch_description():
    ...
    gui_node = Node(
        ...
        executable='FR3HuskyControllerQT',
        name='FR3HuskyControllerQT',
        output='screen',
        emulate_tty=True,
    )
    ...
    teleop_twist_joy_node = Node(
        ...
        remappings=[
            ('cmd_vel', '/fr3_husky_controller/cmd_vel'),
        ],
    )
