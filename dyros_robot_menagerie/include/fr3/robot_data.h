...
*/
    ...
    class FR3RobotData : public RobotData::Manipulator::ManipulatorBase
    {
        public:
            FR3RobotData(); 
            ...
            RobotData::Manipulator::ManipulabilityResult computeManipulability(const VectorXd& q, const VectorXd& qdot, const bool& with_grad, const bool& with_graddot);
